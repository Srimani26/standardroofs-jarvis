...
/**
 * Hooks for HabitCompletion routes
 */
export interface HabitCompletionHooks {
  /**
...
/**
 * Default HabitCompletion hooks (customize as needed)
 */
export const habitCompletionHooks: HabitCompletionHooks = {
