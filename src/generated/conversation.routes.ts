...
/**
 * Auto-generated Conversation Routes
 *
...
import type { ConversationHooks } from "./conversation.hooks"
...
/**
 * Set hooks for Conversation routes
 */
export function setConversationHooks(h: ConversationHooks) {
  hooks = h
}
...
const WRITABLE_SCALAR_FIELDS = ["role", "content", "sessionId", "createdAt"] as const
...
export function createConversationRoutes(): Hono {
  ...
  router.get("/:id", async (c) => {
    try {
      ...
      if (!item) {
        return sendJson(c, { error: { code: "not_found", message: "Conversation not found" } }, 404)
      }
