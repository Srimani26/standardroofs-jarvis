...
/**
 * Hooks for DailySummary routes
 */
export interface DailySummaryHooks {
  /**
...
/**
 * Default DailySummary hooks (customize as needed)
 */
export const dailySummaryHooks: DailySummaryHooks = {
