...
/**
 * Hooks for UserSession routes
 */
export interface UserSessionHooks {
  /**
...
/**
 * Default UserSession hooks (customize as needed)
 */
export const userSessionHooks: UserSessionHooks = {
